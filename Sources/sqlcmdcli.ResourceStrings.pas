...
resourcestring
  ...
  RS_SETUP_DATABASE_START = 'Setup database %s in progress...';
  ...
  RS_CMD_QSWORKLOAD_SERVERNAME_INFO = 'The name of SQL Server instance you want to connect to';
  RS_CMD_QSWORKLOAD_DATABASENAME_INFO = 'The name of the database you want to connect to';
  RS_CMD_QSWORKLOAD_USERNAME_INFO = 'Username';
  RS_CMD_QSWORKLOAD_PASSWORD_INFO = 'Password';
